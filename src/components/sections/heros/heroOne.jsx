      ...
      <div className="container relative">
        <div className="flex flex-col items-center text-center relative z-10">
          <Title size={"7.5xl"} className={"font-normal max-w-[776px]"}>
            ...
            <span className="font-bold">Elementary</span> <span className="font-bold text-destructive-foreground">A Wellness Center</span>
          </Title>
          ...
          <p className="pt-5 max-w-[431px]">Join Us in the Peaceful Healing Hills, Where Skilled Healers Work Their Magic with Care and Compassion</p>
          <div className="mt-6">
