                    ...
                    <SlideUp delay={4}>
                        ...
                        <ul className="flex flex-col lg:gap-[15px] gap-2.5 lg:pt-7.5 pt-5">
                            <li className="text-cream-foreground flex gap-4">
                                <FaLocationDot className='mt-1.5' /> <span className="max-w-[168px]">OnLineHomeSchool</span>
                            </li>
                            <li className="text-cream-foreground flex gap-4">
                                <FaEnvelope className='mt-1.5' /> <Link href="#">vidyaniketan@viday.com</Link>
                            </li>
                            <li className="text-cream-foreground flex gap-4">
                                <FaPhone className='mt-1.5' /> <Link href="#">999999999</Link>
                            </li>
                        </ul>
                    </SlideUp>
