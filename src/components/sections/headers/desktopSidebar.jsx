                    ...
                    <div>
                        ...
                        <ul className="mt-5 flex flex-col gap-[15px]">
                            <li className='flex items-center'>
                                <FaPhone className='text-primary-foreground' /> <a href="" className="ml-2.5">999999999</a>
                            </li>
                            <li className='flex items-center'>
                                <FaEnvelope className='text-primary-foreground' /> <a href="" className="ml-2.5">info@example.com</a>
                            </li>
                            <li className='flex items-center'>
                                <FaLocationDot className='text-primary-foreground' /> <span className="ml-2.5">Online</span>
                            </li>
                        </ul>
                    </div>
                    <div className="mt-5">
